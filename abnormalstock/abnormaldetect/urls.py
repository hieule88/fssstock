...
urlpatterns = [
    ...
    path("taskchart/<str:ref_id>/<str:ref_mack>/", views.taskchart, name="taskchart_param"),
    path("taskdashboard/", views.taskdashboard, name="taskdashboard"),
    path("taskresult/<str:id_modelling>/", views.taskresult, name="taskresult_param"),
    path("taskresult/", views.taskresult, name="taskresult"),
