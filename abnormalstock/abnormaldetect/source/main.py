...
def upload_image(data, typeof, taskid, ref_id, ver):
    try:
    ...
    # Load ticker infor
        try:
            ...
            if numabnormday > abnormthresh:
                ...
                # upload_image([squared_errors, threshold, list(abnormpredict['TXDATE'])],'sq_error', taskid, ref_id)
                # upload_image([real_close_cost, list(abnormpredict['Residual']), list(abnormpredict['TXDATE'])],'residual', taskid, ref_id)
